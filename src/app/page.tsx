...
export default function Home() {
	return (
		<main>
			<section className="py-20 mt-12 sm:mt-16">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="lg:grid lg:grid-cols-3 lg:gap-8">
						...
						<div className="mt-10 lg:mt-0">
							...
							<div className="mt-5">
								<h2 className="text-lg font-medium text-gray-900">Shadcn UI</h2>
								<p className="mt-2 text-base text-gray-500">
						...
						<div className="mt-10 lg:mt-0">
							...
							<div className="mt-5">
								...
								<p className="mt-2 text-base text-gray-500">
									Send emails with React Email and Resend as provider.
								</p>
							</div>
						</div>
					</div>
